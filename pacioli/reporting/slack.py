...
from pacioli.exceptions import SlackChannelError


class SlackPostManager:
    """Main class for interfacing with Slack."""

    def __init__(self, token: str = settings.SLACK_TOKEN) -> None:
    ...
    def post_message_to_channel(
        self,
        channel_name: str = settings.SLACK_CHANNEL_NAME,
        message: str = settings.SLACK_TEST_MESSAGE,
