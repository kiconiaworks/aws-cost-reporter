...
DEFAULT_BOKEH_PHANTOMJS_PATH = "/tmp/phantomjs"
BOKEH_PHANTOMJS_PATH = os.getenv("BOKEH_PHANTOMJS_PATH", DEFAULT_BOKEH_PHANTOMJS_PATH)

DEFAULT_BOKEH_PHANTOMJSXZ_PATH = "/var/task/bin/phantomjs.xz"
BOKEH_PHANTOMJSXZ_PATH = os.getenv("BOKEH_PHANTOMJSXZ_PATH", DEFAULT_BOKEH_PHANTOMJSXZ_PATH)
