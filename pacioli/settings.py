...
AWS_CLIENT_REGION = os.getenv("AWS_CLIENT_REGION", "us-west-2")

DEFAULT_S3_SERVICE_ENDPOINT = f"https://s3.{AWS_CLIENT_REGION}.amazonaws.com"
...
# EC2 - Other breakdown configuration
DEFAULT_BREAKDOWN_EC2_OTHER = True
BREAKDOWN_EC2_OTHER = os.getenv("BREAKDOWN_EC2_OTHER", str(DEFAULT_BREAKDOWN_EC2_OTHER)).lower() in ("true", "1", "yes")
